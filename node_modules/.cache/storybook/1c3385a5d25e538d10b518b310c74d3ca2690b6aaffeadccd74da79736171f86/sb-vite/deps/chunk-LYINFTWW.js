import {
  require_mapValues
} from "./chunk-NW2MRWEX.js";
import {
  require_preview_api
} from "./chunk-5SMCBIFY.js";
import {
  require_doctrine
} from "./chunk-7XE3J3PM.js";
import {
  __toESM
...
var convert = (type) => {
  ...
  switch (typeof raw < "u" && (base.raw = raw), type.name) {
    ...
    case "union":
      let result;
      return ((_a = type.elements) == null ? void 0 : _a.every((element) => element.name === "literal")) ? result = { ...base, name: "enum", value: (_b = type.elements) == null ? void 0 : _b.map((v) => parseLiteral(v.value)) } : result = { ...base, name, value: (_c = type.elements) == null ? void 0 : _c.map(convert) }, result;
    case "intersection":
...
var convert2 = (type) => {
  ...
  switch (typeof raw < "u" && (base.raw = raw), type.name) {
    ...
    case "union":
      return ((_a = type.elements) == null ? void 0 : _a.every(isLiteral)) ? { ...base, name: "enum", value: (_b = type.elements) == null ? void 0 : _b.map(toEnumOption) } : { ...base, name, value: (_c = type.elements) == null ? void 0 : _c.map(convert2) };
    case "intersection":
      return { ...base, name, value: (_d = type.elements) == null ? void 0 : _d.map(convert2) };
    default:
      return { ...base, name: "other", value: name };
  }
};
...
//# sourceMappingURL=chunk-LYINFTWW.js.map
